...
var messages = {   
    ...
    Вам осталось только указать площадку вакансий и интересные для вас профессиональные области!", // и время, когда посылать подборку вакансий
    helloText: "Здравствуйте! Хотите изменить рассылку?",    
    helpMessage: "Я понимаю команды: \n\n\
    ресурс - сменить площадку вакансий;\n\n\
